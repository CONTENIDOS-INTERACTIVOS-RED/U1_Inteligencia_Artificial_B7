        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde sus orígenes, la humanidad ha buscado crear herramientas que faciliten su vida. En este contexto, la Inteligencia Artificial (IA) representa una de las revoluciones tecnológicas más influyentes de nuestro tiempo. En esta unidad, se introducirá al estudiante en el fascinante mundo de la IA, explorando su definición, evolución histórica y principales aplicaciones en sectores como la salud, la educación, la industria y el entretenimiento. 
              
              p #[b ¡Prepárese para afrontar los desafíos de la era digital con pensamiento crítico, análisis y creatividad!]
